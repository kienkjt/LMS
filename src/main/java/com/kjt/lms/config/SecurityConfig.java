    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/courses/*/reviews").hasAnyRole("STUDENT", "INSTRUCTOR")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/courses/*/reviews/me").hasAnyRole("STUDENT", "INSTRUCTOR")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/courses/*/reviews/me").hasAnyRole("STUDENT", "INSTRUCTOR")
                        .requestMatchers(HttpMethod.POST, "/api/v1/courses/*/reviews/*/reply").hasAnyRole("ADMIN", "INSTRUCTOR")
